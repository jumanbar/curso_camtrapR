...
- Incorpora aportes de la comunidad de usuarios, generalmente en forma de paquetes / bibliotecas (Figura 1), pero también a través de tutoriales o cursos, muchos de ellos gratuitos.
...
Recomendación: explorar [datacamp.com](https://www.datacamp.com/community/open-courses), puede que encuentren algún [curso de R en español](https://www.datacamp.com/community/open-courses/introduccion-a-r).
...
Más info: [curso R](https://github.com/jumanbar/Curso-R/blob/master/lecciones/1.3-uso-de-la-ayuda.markdown)
...
```{r 3_errores_solucionado, fig.cap="Figura 2: Al fin salió la figura."}
plot(sort(rnorm(60)), pch=8, col="red", xlab="Rank",
ylab="Variable Gaussiana")
```
